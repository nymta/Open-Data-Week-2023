...
st.write('Bus data is calculated by divind total mileage over total operating time'
         ' Distance and time is measured for each  bus route during peak and off-peak hours'
         )
